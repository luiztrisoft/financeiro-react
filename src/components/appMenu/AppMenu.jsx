...
export class AppMenu extends Component {
    ...
    createMenu() {
         ...
         */
        this.menu = [
            {label: 'Dashboard', icon: 'pi pi-chart-bar', command: () => {window.location = '#/'}},  
            {label: 'Consulta de contas', icon: 'pi pi-money-bill', command: () => {window.location = '#/Consulta'}},   
            {label: 'Cadastro de contas', icon: 'pi pi-plus', command: () => {window.location = '#/Cadastro'}},   
        ];
    }
